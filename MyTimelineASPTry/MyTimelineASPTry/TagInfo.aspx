<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TagInfo.aspx.cs" Inherits="MyTimelineASPTry.TagInfo" Async="true" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div id="pageBodyTagInfo">
            <h2 id="h2TagInfo">About : <asp:Label ID="labelTag" runat="server" Text="tag"></asp:Label></h2> 

            <div id="containerTagDescription" runat="server"></div>
            <div id="containerTagInfo" runat="server"></div>
        </div>
    </form>
</body>
</html>
